...
#define STRING_CONFIG_H_AUTHOR "(EmbeddedTec, Ender-3 Octopus)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 10, 200 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -59, -0.5, 0 }
