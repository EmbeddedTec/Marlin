...
#define STRING_CONFIG_H_AUTHOR "(EmbeddedTec, SW X2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SW X2 Custom"
 ...
 */
//#define Z_MIN_PROBE_PIN PC2 //FWIE:TODO
...
//#define PROBE_OFFSET_XMIN -2.5   // (mm)
